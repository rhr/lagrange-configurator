...
import applications.lagrange.modules.models as models
import applications.lagrange.modules.treeview as treeview
...
def dm_add():
    ...
    redir = request.vars.f or "index"
    # TODO: figure out why request.vars.f is a list
